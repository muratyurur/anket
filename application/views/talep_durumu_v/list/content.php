    ...
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <a class="btn btn-outline btn-info btn-sm pull-right"
               href="<?php echo base_url("talep_durumu/new_form"); ?>">
        ...
        <div class="widget p-lg">
            <?php if (empty($items)) { ?>
                <div class="alert alert-warning text-center" style="padding: 8px; margin-bottom: 0px; s">
                    <p style="font-size: larger">Henüz hiçbir kayıt eklenmemiş. Eklemek için
                        <a href="<?php echo base_url("talep_durumu/new_form"); ?>">
                            tıklayın
                        </a>...
                    </p>
                </div>
                    ...
                    <?php foreach ($items as $item) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <input
                                        data-url="<?php echo base_url("talep_durumu/isActiveSetter/$item->id"); ?>"
                                        class="isActive"
                                        type="checkbox"
                                        data-switchery
                                        data-color="#188ae2"
                            ...
                            <td class="text-center">
                                <button
                                        data-url="<?php echo base_url("talep_durumu/delete/$item->id"); ?>"
                                        type="button"
                                ...
                                <a href="<?php echo base_url("talep_durumu/update_form/$item->id"); ?>">
