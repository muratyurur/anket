        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("users/update/$item->id"); ?>" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-1">
                            <img src="<?php echo ($item->img_url != "") ? base_url("uploads/users_v/$item->img_url") : base_url("uploads/settings_v/nouserphoto.png"); ?>"
                        ...
                        <div>
                            <select class="form-control" data-plugin="select2" name="user_role_id">
                                <?php foreach ($roles as $role) { ?>
                                    <option <?php echo $role->id == $item->user_role_id ? "selected" : "" ; ?> value="<?php echo $role->id; ?>"><?php echo $role->title ; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <a href="<?php echo ($item->user_role_id == 1) ? base_url("users") : base_url(); ?>">
