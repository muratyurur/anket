...
<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <b>Tuzla 2019 Yerel Seçim</b> Hemşehri Çalışması Seçmen Listesi
            <a class="btn btn-outline btn-primary btn-sm pull-right"
               href="<?php echo base_url("hemsehri/new_form"); ?>">
    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <hr>
            <form action="<?php echo base_url("hemsehri/index"); ?>" method="post">
                <div class="row">
                ...
                <div class="row">
                    <a href="<?php echo base_url("hemsehri/clear_session"); ?>">
                    ...
                    <?php foreach ($items as $item) { ?>
                        <tr>
                            <td class="text-center">
                                <a href="<?php echo base_url("hemsehri/update_form/$item->id"); ?>">
