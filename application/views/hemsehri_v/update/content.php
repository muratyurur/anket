    ...
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <a class="btn btn-outline btn-primary btn-sm pull-right"
               href="<?php echo base_url("hemsehri"); ?>">
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("hemsehri/update/$item->id"); ?>" method="post">
    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            <h4 class="m-b-lg">
                ...
                <a class="btn btn-outline btn-primary btn-sm pull-right"
                   href="<?php echo base_url("hemsehri/copy/$item->id"); ?>">
                    ...
                    <?php foreach ($evhalki as $birey) { ?>
                        <tr>
                            <td class="text-center">
                                <a href="<?php echo base_url("hemsehri/update_form/$birey->id"); ?>">
