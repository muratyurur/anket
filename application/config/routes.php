...
$route["email-settings"] = "email_settings";
$route["ekip-gorev"] = "ekip_sokak";
$route["ekip-anketor"] = "ekip_kullanici";
$route["requests"] = "talep_durumu";
$route["ekip-anketor/(:any)"] = "ekip_kullanici/$1";