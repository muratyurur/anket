...
class Ekip extends CI_Controller
{
    ...
    public function save()
    {
        ...
        /** Validation Rules */
        $this->form_validation->set_rules("tanim", "Ekip Adı", "trim|required");
        ...
        if ($validate) {
            ...
            if ($insert) {
                ...
                $alert = array(
                    ...
                    "text" => "Ekip tanımı başarılı bir şekilde eklendi.."
                );
                ...
                $alert = array(
                    ...
                    "text" => "Ekip tanımı işlemi esnasında bir sorun oluştu.."
                );
    ...
    public function update($id)
    {
        ...
        if ($validate) {
            ...
            $update = $this->ekip_model->update(array("id" => $id), $data);
    ...
    public function team_user_match($user_id)
    {
