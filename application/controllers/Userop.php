    ...
    public function reset_password()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $send = send_email($user->email, "Anket Uygulaması Geçici Şifre", "<b>Anket Uygulaması</b>'na giriş yapabilmeniz için geçici şifreniz: <br><br> 
                                        ...
                                        <a href='https://www.tuzlaanket.com/'>tıklayınız</a>");
